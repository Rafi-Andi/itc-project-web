...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100..900;1,100..900&family=Orbitron:wght@400..900&family=Outfit:wght@100..900&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Roboto:ital,wght@0,100..900;1,100..900&family=Sarpanch:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
  ...
  <body class="font-[Montserrat]">
      ...
      <div class="container mx-auto px-3 py-1">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-2">
            <div class="foto">
              <img
                src="./src/assets/images/logoItc.png"
                alt="IT CLUB Logo"
                width="60"
          ...
          <nav class="hidden md:block">
            <ul class="font-medium flex gap-6">
              ...
              <li>
                <a href="#dokumentasi" class="hover:text-primary transition-colors"
                  >Dokumentasi</a
                >
              </li>
              <li>
                <a href="#materi" class="hover:text-primary transition-colors"
                  >Materi</a
                >
              </li>
            </ul>
    ...
    <div id="home" class="relative md:h-[100vh]">
      ...
      >
        <div class="max-w-[700px] px-6 mb-10 md:mb-0" data-aos="fade-up" data-aos-duration="1000">
          <div
            class="mb-6 title bg-[#E7F0F8] inline-block px-6 rounded-xl text-primary"
          >
          ...
          <h1 class="font-bold text-xl">
            ...
            <span class="text-lg font-[Poppins]"
              >(Information Technology Club)</span
            >
          </h1>
      ...
      <div class="container-hiasan hidden md:block">
        <img
          class="absolute right-4 bottom-[200px]"
          src="./src/assets/images/briliant1.png"
          alt=""
          width="80px"
        />
        <img
          class="absolute right-[90px] bottom-[150px]"
          src="./src/assets/images/baut.png"
          alt=""
          width="80px"
        />
        <img
          class="absolute right-7 bottom-[80px]"
          src="./src/assets/images/donat.png"
          alt=""
          width="90px"
        />
      </div>
    ...
    <div
      id="about"
      class="relative md:h-[100vh] pt-10 md:pt-[250px] flex justify-center items-center flex-col"
      data-aos="fade-down"
    ...
    >
      ...
      <div class="container-hiasan hidden md:block">
        <img
          class="absolute left-8 top-0 rotate-90"
          src="./src/assets/images/briliant1.png"
          alt=""
          width="80px"
        />
        <img
          class="absolute left-20 top-[60px]"
          src="./src/assets/images/bautDua.png"
          alt=""
          width="100px"
        />
        <img
          class="absolute left-0 top-[80px] -rotate-90"
          src="./src/assets/images/donat.png"
          alt=""
          width="90px"
        />
    ...
    <div class="mentor md:pt-[200px] px-2">
      <div data-aos="fade-down" data-aos-duration="1000" class="flex items-center justify-center gap-3 text-3xl md:text-4xl text-center font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">
      ...
      <div class="justify-evenly items-center items-start flex flex-wrap">
        ...
        >
          <div
            class="flex flex-wrap md:w-[450px] justify-center items-center md:justify-start md:items-start"
          >
            <h1
              class="font-[poppins] text-center font-bold text-2xl md:text-[36px] mb-4"
            >
              Muhammad Arya
            </h1>
            <h1
              class="font-[orbitron] font-bold text-center text-xl md:text-[24px] mb-4 md:mb-2"
            >
              KETUA DEVGRAF/COACH
            </h1>
          ...
          <div class="flex flex-col">
            <h1
              class="font-[poppins] font-bold text-[24px] md:text-[16px] text-center"
            >
              Software yang di pelajari
            </h1>
            <img
              src="./src/assets/images/toolsDevgraf.png"
              alt=""
              width="300px"
            />
          </div>
      ...
      <div
        class="justify-evenly mt-6 items-center items-start flex flex-wrap flex-col-reverse md:flex-row"
      >
        <div
          data-aos="flip-up"
        ...
        >
          ...
          >
            <h1
              class="font-[poppins] font-bold md:text-[36px] text-center text-2xl mb-4"
            >
              Bima Ardhia Vardan
            </h1>
            <h1
              class="font-[orbitron] font-bold text-[24px] text-xl text-center mb-4 md:mb-2"
            >
          ...
          <div class="flex flex-col">
            ...
            <img
              src="./src/assets/images/toolsPrograming.png"
              alt=""
              width="300px"
            />
          </div>
      ...
      <div class="flex flex-col lg:flex-row items-center justify-between gap-8">
        <div class="flex-1 space-y-6 font-['Poppins']">
          ...
          <p class="text-xl text-gray-700 leading-relaxed">
            <i class="fas fa-lightbulb text-amber-500"></i> Sudah kenalan dengan mentoring HEBAT kami? Saatnya berhenti jadi penonton dan mulai jadi creator!
          </p>
          ...
          <div class="bg-white/50 backdrop-blur-sm p-4 rounded-xl shadow-md border border-blue-100">
            ...
            <ul class="space-y-3">
              ...
              <li class="flex items-center gap-3 text-gray-800">
                <div class="flex-shrink-0 w-8 h-8 flex items-center justify-center bg-indigo-100 text-indigo-600 rounded-full">
  ...
  <div class="container mx-auto mt-10" id="dokumentasi">
    ...
    <div data-aos="zoom-in" data-aos-duration="1200" class="grid grid-cols-1 md:grid-cols-3 gap-2">
      <div class="rounded-lg overflow-hidden shadow-md group relative cursor-pointer">
        <img 
          src="./src/assets/images/dokumentasi1.png" 
      ...
      <div class="rounded-lg overflow-hidden shadow-md group relative cursor-pointer">
        <img 
          src="./src/assets/images/dokumentasi2.png" 
          class="w-full h-56 object-cover transition-transform duration-300 group-hover:scale-110"
        />
      ...
      <div class="rounded-lg overflow-hidden shadow-md group relative cursor-pointer">
        <img 
          src="./src/assets/images/dokumentasi3.png" 
          class="w-full h-56 object-cover transition-transform duration-300 group-hover:scale-110"
        />
      ...
      <div class="col-span-1 md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-2">
        ...
        <div class="rounded-lg overflow-hidden shadow-md group relative cursor-pointer">
          <img 
            src="./src/assets/images/dokumentasi4.png"  
        ...
        <div class="rounded-lg overflow-hidden shadow-md group relative cursor-pointer">
          <img 
            src="./src/assets/images/dokumentasi5.png"  
            class="w-full h-48 object-cover transition-transform duration-300 group-hover:scale-110"
          />
  ...
  <div class="mt-4 md:mt-10 px-4 py-8 flex items-center justify-center">
    <div data-aos="zoom-in" data-aos-duration="1300"  class="flex flex-col w-full max-w-7xl mx-auto p-6 sm:p-10 md:p-12 lg:p-16 bg-gradient-to-b from-[#EBF3FB] via-[#E0F7FF] to-[#E8E5FF] rounded-2xl shadow-xl overflow-hidden">
      <div class="flex items-center justify-center gap-2 sm:gap-3 text-xl sm:text-2xl md:text-3xl lg:text-4xl text-center font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">
        ...
        <h1 class="text-lg sm:text-xl md:text-2xl lg:text-3xl text-center font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">
          Daftar sekarang dan tunjukkan bakatmu!
        </h1>
      </div>
      <div class="text-base sm:text-lg md:text-xl mt-2 font-medium text-center text-gray-700 leading-relaxed flex flex-wrap items-center gap-2 justify-center">
